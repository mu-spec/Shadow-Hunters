...
/// Serves `assets/**` (level JSON, the Phase 9A Hunter PNG, etc.) from disk
...
/// and returns its bytes so both the level loader AND any sprite loading
/// (`rootBundle.load('assets/hunter.png')`) work in tests.
