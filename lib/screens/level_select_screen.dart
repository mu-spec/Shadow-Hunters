...
class _LevelSelectState extends State<LevelSelectScreen> {
  ...
  @override Widget build(BuildContext context){
    final names=['First Shot','Long Shot','Head Hunter','Moving Target','First Battle','Undead Arrival','The Hunted Pair','Twin Terror','Quick Cutter','Bone and Blade','Shambler\'s Rival','Skeleton Swarm','Trio of Terror','Hunter\'s Gauntlet'];
